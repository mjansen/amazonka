...
deletePackage
    :: Text -- ^ 'dPackageId'
    -> DeletePackage
deletePackage pPackageId_ = DeletePackage' {_dPackageId = pPackageId_}
...
data DeletePackageResponse = DeletePackageResponse'
  { _delrsPackageDetails :: !(Maybe PackageDetails)
...
deletePackageResponse pResponseStatus_ =
  DeletePackageResponse'
    {_delrsPackageDetails = Nothing, _delrsResponseStatus = pResponseStatus_}
