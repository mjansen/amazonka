...
newtype DeleteOutboundCrossClusterSearchConnection = DeleteOutboundCrossClusterSearchConnection'
  { _doccscCrossClusterSearchConnectionId :: Text
...
deleteOutboundCrossClusterSearchConnection
    ...
    -> DeleteOutboundCrossClusterSearchConnection
deleteOutboundCrossClusterSearchConnection pCrossClusterSearchConnectionId_ =
  DeleteOutboundCrossClusterSearchConnection'
    {_doccscCrossClusterSearchConnectionId = pCrossClusterSearchConnectionId_}
...
data DeleteOutboundCrossClusterSearchConnectionResponse = DeleteOutboundCrossClusterSearchConnectionResponse'
  { _doccscrsCrossClusterSearchConnection :: !(Maybe OutboundCrossClusterSearchConnection)
  , _doccscrsResponseStatus :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
deleteOutboundCrossClusterSearchConnectionResponse pResponseStatus_ =
  DeleteOutboundCrossClusterSearchConnectionResponse'
    { _doccscrsCrossClusterSearchConnection = Nothing
