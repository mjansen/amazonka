...
newtype DeleteInboundCrossClusterSearchConnection = DeleteInboundCrossClusterSearchConnection'
  { _diccscCrossClusterSearchConnectionId :: Text
...
deleteInboundCrossClusterSearchConnection
    ...
    -> DeleteInboundCrossClusterSearchConnection
deleteInboundCrossClusterSearchConnection pCrossClusterSearchConnectionId_ =
  DeleteInboundCrossClusterSearchConnection'
    {_diccscCrossClusterSearchConnectionId = pCrossClusterSearchConnectionId_}
...
data DeleteInboundCrossClusterSearchConnectionResponse = DeleteInboundCrossClusterSearchConnectionResponse'
  { _diccscirsCrossClusterSearchConnection :: !(Maybe InboundCrossClusterSearchConnection)
  , _diccscirsResponseStatus :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
deleteInboundCrossClusterSearchConnectionResponse pResponseStatus_ =
  DeleteInboundCrossClusterSearchConnectionResponse'
    { _diccscirsCrossClusterSearchConnection = Nothing
