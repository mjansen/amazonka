...
data DescribeOutboundCrossClusterSearchConnections = DescribeOutboundCrossClusterSearchConnections'
  { _doccscFilters    :: !(Maybe [Filter])
  , _doccscNextToken  :: !(Maybe Text)
  , _doccscMaxResults :: !(Maybe Int)
...
data DescribeOutboundCrossClusterSearchConnectionsResponse = DescribeOutboundCrossClusterSearchConnectionsResponse'
  { _drsCrossClusterSearchConnections :: !(Maybe [OutboundCrossClusterSearchConnection])
...
describeOutboundCrossClusterSearchConnectionsResponse
    ...
    -> DescribeOutboundCrossClusterSearchConnectionsResponse
describeOutboundCrossClusterSearchConnectionsResponse pResponseStatus_ =
  DescribeOutboundCrossClusterSearchConnectionsResponse'
    { _drsCrossClusterSearchConnections = Nothing
