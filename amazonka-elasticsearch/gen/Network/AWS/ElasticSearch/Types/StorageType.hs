...
data StorageType = StorageType'{_stStorageTypeLimits
...
storageType = StorageType' { _stStorageTypeLimits  = Nothing
...
stStorageTypeLimits =
  lens _stStorageTypeLimits (\s a -> s { _stStorageTypeLimits = a })
    . _Default
    . _Coerce
...
stStorageSubTypeName =
  lens _stStorageSubTypeName (\s a -> s { _stStorageSubTypeName = a })

-- | Undocumented member.
stStorageTypeName :: Lens' StorageType (Maybe Text)
stStorageTypeName =
  lens _stStorageTypeName (\s a -> s { _stStorageTypeName = a })
