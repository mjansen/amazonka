...
data VPCDerivedInfo = VPCDerivedInfo'{_vdiSecurityGroupIds
                                      :: !(Maybe [Text]),
...
vpcDerivedInfo = VPCDerivedInfo' { _vdiSecurityGroupIds  = Nothing
...
vdiSecurityGroupIds =
  lens _vdiSecurityGroupIds (\s a -> s { _vdiSecurityGroupIds = a })
    . _Default
    . _Coerce
...
vdiSubnetIds =
  lens _vdiSubnetIds (\s a -> s { _vdiSubnetIds = a }) . _Default . _Coerce
...
vdiAvailabilityZones =
  lens _vdiAvailabilityZones (\s a -> s { _vdiAvailabilityZones = a })
    . _Default
    . _Coerce
