...
data InstanceCountLimits = InstanceCountLimits'{_iclMaximumInstanceCount
                                                :: !(Maybe Int),
...
instanceCountLimits = InstanceCountLimits' { _iclMaximumInstanceCount = Nothing
...
iclMaximumInstanceCount =
  lens _iclMaximumInstanceCount (\s a -> s { _iclMaximumInstanceCount = a })

-- | Undocumented member.
iclMinimumInstanceCount :: Lens' InstanceCountLimits (Maybe Int)
iclMinimumInstanceCount =
  lens _iclMinimumInstanceCount (\s a -> s { _iclMinimumInstanceCount = a })
