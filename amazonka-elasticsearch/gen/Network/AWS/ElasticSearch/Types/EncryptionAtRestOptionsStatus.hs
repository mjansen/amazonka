...
data EncryptionAtRestOptionsStatus = EncryptionAtRestOptionsStatus'{_earosOptions
                                                                    ::
...
encryptionAtRestOptionsStatus pOptions_ pStatus_ =
  EncryptionAtRestOptionsStatus' { _earosOptions = pOptions_
...
instance FromJSON EncryptionAtRestOptionsStatus where
  parseJSON = withObject
    "EncryptionAtRestOptionsStatus"
    (\x ->
      EncryptionAtRestOptionsStatus' <$> (x .: "Options") <*> (x .: "Status")
    )
