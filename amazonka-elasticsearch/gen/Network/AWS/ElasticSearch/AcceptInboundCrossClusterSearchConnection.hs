...
newtype AcceptInboundCrossClusterSearchConnection = AcceptInboundCrossClusterSearchConnection'
  { _aiccscCrossClusterSearchConnectionId :: Text
...
acceptInboundCrossClusterSearchConnection
    ...
    -> AcceptInboundCrossClusterSearchConnection
acceptInboundCrossClusterSearchConnection pCrossClusterSearchConnectionId_ =
  AcceptInboundCrossClusterSearchConnection'
    {_aiccscCrossClusterSearchConnectionId = pCrossClusterSearchConnectionId_}
...
data AcceptInboundCrossClusterSearchConnectionResponse = AcceptInboundCrossClusterSearchConnectionResponse'
  { _aiccscrsCrossClusterSearchConnection :: !(Maybe InboundCrossClusterSearchConnection)
  , _aiccscrsResponseStatus :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
acceptInboundCrossClusterSearchConnectionResponse pResponseStatus_ =
  AcceptInboundCrossClusterSearchConnectionResponse'
    { _aiccscrsCrossClusterSearchConnection = Nothing
