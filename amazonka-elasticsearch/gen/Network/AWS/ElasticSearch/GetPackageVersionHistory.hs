...
data GetPackageVersionHistoryResponse = GetPackageVersionHistoryResponse'
  { _gpvhrsPackageId                 :: !(Maybe Text)
  , _gpvhrsPackageVersionHistoryList :: !(Maybe [PackageVersionHistory])
  , _gpvhrsNextToken                 :: !(Maybe Text)
  , _gpvhrsResponseStatus            :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
