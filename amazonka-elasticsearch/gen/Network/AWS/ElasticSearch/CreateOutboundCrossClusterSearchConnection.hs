...
data CreateOutboundCrossClusterSearchConnection = CreateOutboundCrossClusterSearchConnection'
  { _coccscSourceDomainInfo      :: !DomainInformation
  , _coccscDestinationDomainInfo :: !DomainInformation
  , _coccscConnectionAlias       :: !Text
...
createOutboundCrossClusterSearchConnection
    ...
    -> CreateOutboundCrossClusterSearchConnection
createOutboundCrossClusterSearchConnection pSourceDomainInfo_ pDestinationDomainInfo_ pConnectionAlias_ =
  CreateOutboundCrossClusterSearchConnection'
    { _coccscSourceDomainInfo = pSourceDomainInfo_
    , _coccscDestinationDomainInfo = pDestinationDomainInfo_
...
data CreateOutboundCrossClusterSearchConnectionResponse = CreateOutboundCrossClusterSearchConnectionResponse'
  { _coccscrsDestinationDomainInfo :: !(Maybe DomainInformation)
  , _coccscrsConnectionAlias :: !(Maybe Text)
  , _coccscrsCrossClusterSearchConnectionId :: !(Maybe Text)
  , _coccscrsConnectionStatus :: !(Maybe OutboundCrossClusterSearchConnectionStatus)
  , _coccscrsSourceDomainInfo :: !(Maybe DomainInformation)
  , _coccscrsResponseStatus :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
createOutboundCrossClusterSearchConnectionResponse pResponseStatus_ =
  CreateOutboundCrossClusterSearchConnectionResponse'
    { _coccscrsDestinationDomainInfo = Nothing
    , _coccscrsConnectionAlias = Nothing
    , _coccscrsCrossClusterSearchConnectionId = Nothing
