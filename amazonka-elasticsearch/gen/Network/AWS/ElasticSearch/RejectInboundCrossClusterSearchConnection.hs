...
newtype RejectInboundCrossClusterSearchConnection = RejectInboundCrossClusterSearchConnection'
  { _riccscCrossClusterSearchConnectionId :: Text
...
rejectInboundCrossClusterSearchConnection
    ...
    -> RejectInboundCrossClusterSearchConnection
rejectInboundCrossClusterSearchConnection pCrossClusterSearchConnectionId_ =
  RejectInboundCrossClusterSearchConnection'
    {_riccscCrossClusterSearchConnectionId = pCrossClusterSearchConnectionId_}
...
data RejectInboundCrossClusterSearchConnectionResponse = RejectInboundCrossClusterSearchConnectionResponse'
  { _riccscrsCrossClusterSearchConnection :: !(Maybe InboundCrossClusterSearchConnection)
  , _riccscrsResponseStatus :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
rejectInboundCrossClusterSearchConnectionResponse pResponseStatus_ =
  RejectInboundCrossClusterSearchConnectionResponse'
    { _riccscrsCrossClusterSearchConnection = Nothing
