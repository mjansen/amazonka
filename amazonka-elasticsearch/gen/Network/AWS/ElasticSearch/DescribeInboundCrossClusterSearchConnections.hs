...
data DescribeInboundCrossClusterSearchConnections = DescribeInboundCrossClusterSearchConnections'
  { _diccscFilters    :: !(Maybe [Filter])
  , _diccscNextToken  :: !(Maybe Text)
  , _diccscMaxResults :: !(Maybe Int)
...
data DescribeInboundCrossClusterSearchConnectionsResponse = DescribeInboundCrossClusterSearchConnectionsResponse'
  { _diccscrsCrossClusterSearchConnections :: !(Maybe [InboundCrossClusterSearchConnection])
  , _diccscrsNextToken :: !(Maybe Text)
  , _diccscrsResponseStatus :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
describeInboundCrossClusterSearchConnectionsResponse
    ...
    -> DescribeInboundCrossClusterSearchConnectionsResponse
describeInboundCrossClusterSearchConnectionsResponse pResponseStatus_ =
  DescribeInboundCrossClusterSearchConnectionsResponse'
    { _diccscrsCrossClusterSearchConnections = Nothing
    , _diccscrsNextToken = Nothing
    , _diccscrsResponseStatus = pResponseStatus_
    }
