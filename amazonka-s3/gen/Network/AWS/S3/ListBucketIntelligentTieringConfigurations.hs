...
data ListBucketIntelligentTieringConfigurations = ListBucketIntelligentTieringConfigurations'
  { _lbitcContinuationToken :: !(Maybe Text)
  , _lbitcBucket            :: !BucketName
...
listBucketIntelligentTieringConfigurations pBucket_ =
  ListBucketIntelligentTieringConfigurations'
    {_lbitcContinuationToken = Nothing, _lbitcBucket = pBucket_}
...
data ListBucketIntelligentTieringConfigurationsResponse = ListBucketIntelligentTieringConfigurationsResponse'
  { _lbitcrsIntelligentTieringConfigurationList :: !(Maybe [IntelligentTieringConfiguration])
  , _lbitcrsContinuationToken :: !(Maybe Text)
  , _lbitcrsNextContinuationToken :: !(Maybe Text)
  , _lbitcrsIsTruncated :: !(Maybe Bool)
  , _lbitcrsResponseStatus :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
