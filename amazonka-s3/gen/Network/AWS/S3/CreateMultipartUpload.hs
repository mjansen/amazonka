...
data CreateMultipartUpload = CreateMultipartUpload'
  ...
  , _cmuBucketKeyEnabled          :: !(Maybe Bool)
  ...
  , _cmuSSEKMSEncryptionContext   :: !(Maybe (Sensitive Text))
