...
data CreateTransitGatewayMulticastDomain = CreateTransitGatewayMulticastDomain'
  ...
  , _ctgmdOptions :: !(Maybe CreateTransitGatewayMulticastDomainRequestOptions)
...
instance ToPath CreateTransitGatewayMulticastDomain
         where
        toPath = const "/"

instance ToQuery CreateTransitGatewayMulticastDomain
         where
        toQuery CreateTransitGatewayMulticastDomain'{..}
          = mconcat
              ["Action" =:
               ...
               "Options" =: _ctgmdOptions, "DryRun" =: _ctgmdDryRun,
