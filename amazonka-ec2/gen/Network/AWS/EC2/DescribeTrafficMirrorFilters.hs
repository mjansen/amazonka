...
data DescribeTrafficMirrorFilters = DescribeTrafficMirrorFilters'
  { _dtmfTrafficMirrorFilterIds :: !(Maybe [Text])
...
describeTrafficMirrorFilters =
  DescribeTrafficMirrorFilters'
    { _dtmfTrafficMirrorFilterIds = Nothing
...
instance AWSPager DescribeTrafficMirrorFilters where
        page rq rs
          ...
          | otherwise =
            Just $ rq & dtmfNextToken .~ rs ^. dtmfsrsNextToken

instance AWSRequest DescribeTrafficMirrorFilters
         where
...
instance Hashable DescribeTrafficMirrorFilters where

instance NFData DescribeTrafficMirrorFilters where
...
data DescribeTrafficMirrorFiltersResponse = DescribeTrafficMirrorFiltersResponse'
  { _dtmfsrsTrafficMirrorFilters :: !(Maybe [TrafficMirrorFilter])
  , _dtmfsrsNextToken            :: !(Maybe Text)
  , _dtmfsrsResponseStatus       :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
describeTrafficMirrorFiltersResponse
    :: Int -- ^ 'dtmfsrsResponseStatus'
    -> DescribeTrafficMirrorFiltersResponse
describeTrafficMirrorFiltersResponse pResponseStatus_ =
  DescribeTrafficMirrorFiltersResponse'
    { _dtmfsrsTrafficMirrorFilters = Nothing
