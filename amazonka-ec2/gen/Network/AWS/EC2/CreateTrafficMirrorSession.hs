...
createTrafficMirrorSession
    :: Text -- ^ 'ctmsNetworkInterfaceId'
    -> Text -- ^ 'ctmsTrafficMirrorTargetId'
...
instance Hashable CreateTrafficMirrorSession where

instance NFData CreateTrafficMirrorSession where
