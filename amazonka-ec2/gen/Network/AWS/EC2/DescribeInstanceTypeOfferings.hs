...
instance AWSPager DescribeInstanceTypeOfferings where
        page rq rs
          ...
          | otherwise =
            Just $ rq & ditoNextToken .~ rs ^. ditorsNextToken

instance AWSRequest DescribeInstanceTypeOfferings
         where
...
instance Hashable DescribeInstanceTypeOfferings where

instance NFData DescribeInstanceTypeOfferings where

instance ToHeaders DescribeInstanceTypeOfferings
         where
