...
data DeleteTransitGatewayPrefixListReference = DeleteTransitGatewayPrefixListReference'
  { _dtgplrDryRun                     :: !(Maybe Bool)
  , _dtgplrTransitGatewayRouteTableId :: !Text
  , _dtgplrPrefixListId               :: !Text
...
deleteTransitGatewayPrefixListReference
    :: Text -- ^ 'dtgplrTransitGatewayRouteTableId'
    -> Text -- ^ 'dtgplrPrefixListId'
    -> DeleteTransitGatewayPrefixListReference
deleteTransitGatewayPrefixListReference pTransitGatewayRouteTableId_ pPrefixListId_ =
  DeleteTransitGatewayPrefixListReference'
    { _dtgplrDryRun = Nothing
    , _dtgplrTransitGatewayRouteTableId = pTransitGatewayRouteTableId_
...
data DeleteTransitGatewayPrefixListReferenceResponse = DeleteTransitGatewayPrefixListReferenceResponse'
  { _dtgplrrsTransitGatewayPrefixListReference :: !(Maybe TransitGatewayPrefixListReference)
  , _dtgplrrsResponseStatus :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
deleteTransitGatewayPrefixListReferenceResponse
    :: Int -- ^ 'dtgplrrsResponseStatus'
    -> DeleteTransitGatewayPrefixListReferenceResponse
deleteTransitGatewayPrefixListReferenceResponse pResponseStatus_ =
  DeleteTransitGatewayPrefixListReferenceResponse'
    { _dtgplrrsTransitGatewayPrefixListReference = Nothing
