...
instance AWSRequest CreateLocalGatewayRoute where
        type Rs CreateLocalGatewayRoute =
             CreateLocalGatewayRouteResponse
...
instance Hashable CreateLocalGatewayRoute where

instance NFData CreateLocalGatewayRoute where
...
instance NFData CreateLocalGatewayRouteResponse where
