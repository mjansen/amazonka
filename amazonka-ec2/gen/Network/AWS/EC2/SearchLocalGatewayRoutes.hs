...
instance AWSPager SearchLocalGatewayRoutes where
        page rq rs
          ...
          | otherwise =
            Just $ rq & slgrNextToken .~ rs ^. slgrrsNextToken

instance AWSRequest SearchLocalGatewayRoutes where
        type Rs SearchLocalGatewayRoutes =
             SearchLocalGatewayRoutesResponse
...
instance Hashable SearchLocalGatewayRoutes where

instance NFData SearchLocalGatewayRoutes where
