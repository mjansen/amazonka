...
instance AWSRequest ResetEBSDefaultKMSKeyId where
        type Rs ResetEBSDefaultKMSKeyId =
             ResetEBSDefaultKMSKeyIdResponse
...
instance Hashable ResetEBSDefaultKMSKeyId where

instance NFData ResetEBSDefaultKMSKeyId where
...
instance NFData ResetEBSDefaultKMSKeyIdResponse where
