...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'cssrsSubnet' - Information about the subnet.
--
...
createSubnetResponse pResponseStatus_ =
  CreateSubnetResponse'
    {_cssrsSubnet = Nothing, _cssrsResponseStatus = pResponseStatus_}


-- | Information about the subnet.
cssrsSubnet :: Lens' CreateSubnetResponse (Maybe Subnet)
cssrsSubnet = lens _cssrsSubnet (\ s a -> s{_cssrsSubnet = a})

-- | -- | The response status code.
cssrsResponseStatus :: Lens' CreateSubnetResponse Int
