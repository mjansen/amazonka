...
data GetTransitGatewayPrefixListReferences = GetTransitGatewayPrefixListReferences'
  { _gtgplrFilters                    :: !(Maybe [Filter])
  , _gtgplrNextToken                  :: !(Maybe Text)
  , _gtgplrDryRun                     :: !(Maybe Bool)
  , _gtgplrMaxResults                 :: !(Maybe Nat)
  , _gtgplrTransitGatewayRouteTableId :: !Text
...
getTransitGatewayPrefixListReferences
    :: Text -- ^ 'gtgplrTransitGatewayRouteTableId'
    -> GetTransitGatewayPrefixListReferences
getTransitGatewayPrefixListReferences pTransitGatewayRouteTableId_ =
  GetTransitGatewayPrefixListReferences'
    ...
    , _gtgplrTransitGatewayRouteTableId = pTransitGatewayRouteTableId_
    }
...
instance AWSPager
        ...
        page rq rs
          ...
          | stop
              (rs ^. gtgplrrsTransitGatewayPrefixListReferences)
            = Nothing
          | otherwise =
            Just $ rq &
              gtgplrNextToken .~ rs ^. gtgplrrsNextToken
...
instance ToPath GetTransitGatewayPrefixListReferences
         where
        toPath = const "/"
...
data GetTransitGatewayPrefixListReferencesResponse = GetTransitGatewayPrefixListReferencesResponse'
  { _gtgplrrsTransitGatewayPrefixListReferences :: !(Maybe [TransitGatewayPrefixListReference])
  , _gtgplrrsNextToken :: !(Maybe Text)
  , _gtgplrrsResponseStatus :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
getTransitGatewayPrefixListReferencesResponse
    :: Int -- ^ 'gtgplrrsResponseStatus'
    -> GetTransitGatewayPrefixListReferencesResponse
getTransitGatewayPrefixListReferencesResponse pResponseStatus_ =
  GetTransitGatewayPrefixListReferencesResponse'
    { _gtgplrrsTransitGatewayPrefixListReferences = Nothing
