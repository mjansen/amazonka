...
data RestoreManagedPrefixListVersion = RestoreManagedPrefixListVersion'
  { _rmplvDryRun          :: !(Maybe Bool)
  , _rmplvPrefixListId    :: !Text
  , _rmplvPreviousVersion :: !Integer
  , _rmplvCurrentVersion  :: !Integer
...
restoreManagedPrefixListVersion
    :: Text -- ^ 'rmplvPrefixListId'
    -> Integer -- ^ 'rmplvPreviousVersion'
    -> Integer -- ^ 'rmplvCurrentVersion'
    -> RestoreManagedPrefixListVersion
restoreManagedPrefixListVersion pPrefixListId_ pPreviousVersion_ pCurrentVersion_ =
  RestoreManagedPrefixListVersion'
...
instance AWSRequest RestoreManagedPrefixListVersion
         where
...
instance NFData RestoreManagedPrefixListVersion where

instance ToHeaders RestoreManagedPrefixListVersion
         where
...
instance ToQuery RestoreManagedPrefixListVersion
         where
...
data RestoreManagedPrefixListVersionResponse = RestoreManagedPrefixListVersionResponse'
  { _rmplvrsPrefixList     :: !(Maybe ManagedPrefixList)
  , _rmplvrsResponseStatus :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
restoreManagedPrefixListVersionResponse
    :: Int -- ^ 'rmplvrsResponseStatus'
    -> RestoreManagedPrefixListVersionResponse
restoreManagedPrefixListVersionResponse pResponseStatus_ =
  RestoreManagedPrefixListVersionResponse'
    {_rmplvrsPrefixList = Nothing, _rmplvrsResponseStatus = pResponseStatus_}
