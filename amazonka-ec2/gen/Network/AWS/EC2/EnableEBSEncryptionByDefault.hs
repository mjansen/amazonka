...
instance AWSRequest EnableEBSEncryptionByDefault
         where
...
instance Hashable EnableEBSEncryptionByDefault where

instance NFData EnableEBSEncryptionByDefault where
...
data EnableEBSEncryptionByDefaultResponse = EnableEBSEncryptionByDefaultResponse'
  { _eeebdrsEBSEncryptionByDefault :: !(Maybe Bool)
  , _eeebdrsResponseStatus         :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
enableEBSEncryptionByDefaultResponse
    :: Int -- ^ 'eeebdrsResponseStatus'
    -> EnableEBSEncryptionByDefaultResponse
enableEBSEncryptionByDefaultResponse pResponseStatus_ =
  EnableEBSEncryptionByDefaultResponse'
    { _eeebdrsEBSEncryptionByDefault = Nothing
