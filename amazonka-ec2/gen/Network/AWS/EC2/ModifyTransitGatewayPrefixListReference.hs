...
data ModifyTransitGatewayPrefixListReference = ModifyTransitGatewayPrefixListReference'
  { _mtgplrBlackhole                  :: !(Maybe Bool)
  , _mtgplrTransitGatewayAttachmentId :: !(Maybe Text)
  , _mtgplrDryRun                     :: !(Maybe Bool)
  , _mtgplrTransitGatewayRouteTableId :: !Text
  , _mtgplrPrefixListId               :: !Text
...
modifyTransitGatewayPrefixListReference
    :: Text -- ^ 'mtgplrTransitGatewayRouteTableId'
    -> Text -- ^ 'mtgplrPrefixListId'
    -> ModifyTransitGatewayPrefixListReference
modifyTransitGatewayPrefixListReference pTransitGatewayRouteTableId_ pPrefixListId_ =
  ModifyTransitGatewayPrefixListReference'
    { _mtgplrBlackhole = Nothing
    , _mtgplrTransitGatewayAttachmentId = Nothing
    , _mtgplrDryRun = Nothing
    , _mtgplrTransitGatewayRouteTableId = pTransitGatewayRouteTableId_
...
data ModifyTransitGatewayPrefixListReferenceResponse = ModifyTransitGatewayPrefixListReferenceResponse'
  { _mtgplrrsTransitGatewayPrefixListReference :: !(Maybe TransitGatewayPrefixListReference)
  , _mtgplrrsResponseStatus :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
modifyTransitGatewayPrefixListReferenceResponse
    :: Int -- ^ 'mtgplrrsResponseStatus'
    -> ModifyTransitGatewayPrefixListReferenceResponse
modifyTransitGatewayPrefixListReferenceResponse pResponseStatus_ =
  ModifyTransitGatewayPrefixListReferenceResponse'
    { _mtgplrrsTransitGatewayPrefixListReference = Nothing
