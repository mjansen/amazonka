...
instance AWSPager DescribeByoipCidrs where
        page rq rs
          ...
          | otherwise =
            Just $ rq & dbcNextToken .~ rs ^. dbcrsNextToken

instance AWSRequest DescribeByoipCidrs where
        type Rs DescribeByoipCidrs =
             DescribeByoipCidrsResponse
...
instance Hashable DescribeByoipCidrs where

instance NFData DescribeByoipCidrs where
        ...
        toQuery DescribeByoipCidrs'{..}
          = mconcat
              ["Action" =: ("DescribeByoipCidrs" :: ByteString),
               ...
               "NextToken" =: _dbcNextToken, "DryRun" =: _dbcDryRun,
...
instance NFData DescribeByoipCidrsResponse where
