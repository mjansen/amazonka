...
instance AWSRequest DisableEBSEncryptionByDefault
         where
...
instance Hashable DisableEBSEncryptionByDefault where

instance NFData DisableEBSEncryptionByDefault where

instance ToHeaders DisableEBSEncryptionByDefault
         where
