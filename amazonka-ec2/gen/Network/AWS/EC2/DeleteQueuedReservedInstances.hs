...
instance AWSRequest DeleteQueuedReservedInstances
         where
...
instance Hashable DeleteQueuedReservedInstances where

instance NFData DeleteQueuedReservedInstances where

instance ToHeaders DeleteQueuedReservedInstances
         where
