...
data CreateCarrierGateway = CreateCarrierGateway'
  { _ccgcClientToken       :: !(Maybe Text)
  , _ccgcTagSpecifications :: !(Maybe [TagSpecification])
...
instance Hashable CreateCarrierGateway where

instance NFData CreateCarrierGateway where
...
createCarrierGatewayResponse
    :: Int -- ^ 'ccgcrsResponseStatus'
    -> CreateCarrierGatewayResponse
createCarrierGatewayResponse pResponseStatus_ =
  CreateCarrierGatewayResponse'
    {_ccgcrsCarrierGateway = Nothing, _ccgcrsResponseStatus = pResponseStatus_}
...
instance NFData CreateCarrierGatewayResponse where
