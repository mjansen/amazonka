...
data ModifyTransitGateway = ModifyTransitGateway'
  { _mtgOptions          :: !(Maybe ModifyTransitGatewayOptions)
...
instance Hashable ModifyTransitGateway where

instance NFData ModifyTransitGateway where
...
data ModifyTransitGatewayResponse = ModifyTransitGatewayResponse'
  { _mtgrsTransitGateway :: !(Maybe TransitGateway)
...
modifyTransitGatewayResponse pResponseStatus_ =
  ModifyTransitGatewayResponse'
    {_mtgrsTransitGateway = Nothing, _mtgrsResponseStatus = pResponseStatus_}
...
instance NFData ModifyTransitGatewayResponse where
