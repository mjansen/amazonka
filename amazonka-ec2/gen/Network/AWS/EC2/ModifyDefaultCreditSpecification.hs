...
instance AWSRequest ModifyDefaultCreditSpecification
         where
...
instance ToHeaders ModifyDefaultCreditSpecification
         where
        toHeaders = const mempty

instance ToPath ModifyDefaultCreditSpecification
         where
        toPath = const "/"

instance ToQuery ModifyDefaultCreditSpecification
         where
