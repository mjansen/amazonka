...
instance AWSRequest DeleteTrafficMirrorFilterRule
         where
...
instance Hashable DeleteTrafficMirrorFilterRule where

instance NFData DeleteTrafficMirrorFilterRule where

instance ToHeaders DeleteTrafficMirrorFilterRule
         where
