...
--
-- * 'dssSnapshotIds' - The snapshot IDs. Default: Describes the snapshots for which you have create volume permissions.
--
-- * 'dssRestorableByUserIds' - The IDs of the AWS accounts that can create volumes from the snapshot.
--
