...
instance AWSPager DescribeCarrierGateways where
        page rq rs
          ...
          | otherwise =
            Just $ rq & dcgsNextToken .~ rs ^. dcgsrsNextToken

instance AWSRequest DescribeCarrierGateways where
        type Rs DescribeCarrierGateways =
             DescribeCarrierGatewaysResponse
...
instance Hashable DescribeCarrierGateways where

instance NFData DescribeCarrierGateways where
...
data DescribeCarrierGatewaysResponse = DescribeCarrierGatewaysResponse'
  { _dcgsrsNextToken       :: !(Maybe Text)
  , _dcgsrsCarrierGateways :: !(Maybe [CarrierGateway])
  , _dcgsrsResponseStatus  :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
instance NFData DescribeCarrierGatewaysResponse where
