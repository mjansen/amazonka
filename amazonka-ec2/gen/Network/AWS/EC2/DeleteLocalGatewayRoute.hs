...
instance AWSRequest DeleteLocalGatewayRoute where
        type Rs DeleteLocalGatewayRoute =
             DeleteLocalGatewayRouteResponse
...
instance Hashable DeleteLocalGatewayRoute where

instance NFData DeleteLocalGatewayRoute where
...
instance NFData DeleteLocalGatewayRouteResponse where
