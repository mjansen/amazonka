...
instance AWSPager DescribeFastSnapshotRestores where
        page rq rs
          ...
          | otherwise =
            Just $ rq & dfsrNextToken .~ rs ^. dfsrsrsNextToken

instance AWSRequest DescribeFastSnapshotRestores
         where
...
instance Hashable DescribeFastSnapshotRestores where

instance NFData DescribeFastSnapshotRestores where
