...
data DisassociateEnclaveCertificateIAMRole = DisassociateEnclaveCertificateIAMRole'
  { _decirCertificateARN :: !(Maybe Text)
  , _decirDryRun         :: !(Maybe Bool)
  , _decirRoleARN        :: !(Maybe Text)
...
instance ToPath DisassociateEnclaveCertificateIAMRole
         where
        toPath = const "/"
        ...
        toQuery DisassociateEnclaveCertificateIAMRole'{..}
          = mconcat
              ["Action" =:
               ...
               "DryRun" =: _decirDryRun, "RoleArn" =: _decirRoleARN]
...
data DisassociateEnclaveCertificateIAMRoleResponse = DisassociateEnclaveCertificateIAMRoleResponse'
  { _decirrsReturn         :: !(Maybe Bool)
  , _decirrsResponseStatus :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
disassociateEnclaveCertificateIAMRoleResponse
    :: Int -- ^ 'decirrsResponseStatus'
    -> DisassociateEnclaveCertificateIAMRoleResponse
disassociateEnclaveCertificateIAMRoleResponse pResponseStatus_ =
  DisassociateEnclaveCertificateIAMRoleResponse'
    {_decirrsReturn = Nothing, _decirrsResponseStatus = pResponseStatus_}
