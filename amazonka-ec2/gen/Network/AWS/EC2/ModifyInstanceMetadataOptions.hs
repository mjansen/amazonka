...
instance AWSRequest ModifyInstanceMetadataOptions
         where
...
instance Hashable ModifyInstanceMetadataOptions where

instance NFData ModifyInstanceMetadataOptions where

instance ToHeaders ModifyInstanceMetadataOptions
         where
