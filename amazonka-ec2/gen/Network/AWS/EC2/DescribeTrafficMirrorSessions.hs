...
instance AWSPager DescribeTrafficMirrorSessions where
        page rq rs
          ...
          | otherwise =
            Just $ rq & dtmsNextToken .~ rs ^. dtmsrsNextToken

instance AWSRequest DescribeTrafficMirrorSessions
         where
...
instance Hashable DescribeTrafficMirrorSessions where

instance NFData DescribeTrafficMirrorSessions where

instance ToHeaders DescribeTrafficMirrorSessions
         where
