...
createTrafficMirrorFilterRule
    :: Text -- ^ 'ctmfrTrafficMirrorFilterId'
    -> TrafficDirection -- ^ 'ctmfrTrafficDirection'
    -> Int -- ^ 'ctmfrRuleNumber'
    -> TrafficMirrorRuleAction -- ^ 'ctmfrRuleAction'
...
instance AWSRequest CreateTrafficMirrorFilterRule
         where
...
instance Hashable CreateTrafficMirrorFilterRule where

instance NFData CreateTrafficMirrorFilterRule where

instance ToHeaders CreateTrafficMirrorFilterRule
         where
