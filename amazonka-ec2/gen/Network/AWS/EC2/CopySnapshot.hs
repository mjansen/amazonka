...
data CopySnapshot = CopySnapshot'
  { _copDestinationOutpostARN :: !(Maybe Text)
...
copySnapshot pSourceRegion_ pSourceSnapshotId_ =
  CopySnapshot'
    { _copDestinationOutpostARN = Nothing
...
copDestinationOutpostARN :: Lens' CopySnapshot (Maybe Text)
copDestinationOutpostARN = lens _copDestinationOutpostARN (\ s a -> s{_copDestinationOutpostARN = a})
        ...
        toQuery CopySnapshot'{..}
          = mconcat
              ["Action" =: ("CopySnapshot" :: ByteString),
               ...
               "DestinationOutpostArn" =: _copDestinationOutpostARN,
