...
deleteCarrierGateway
    :: Text -- ^ 'dcgcCarrierGatewayId'
    -> DeleteCarrierGateway
deleteCarrierGateway pCarrierGatewayId_ =
  DeleteCarrierGateway'
    {_dcgcDryRun = Nothing, _dcgcCarrierGatewayId = pCarrierGatewayId_}
...
instance Hashable DeleteCarrierGateway where

instance NFData DeleteCarrierGateway where
...
data DeleteCarrierGatewayResponse = DeleteCarrierGatewayResponse'
  { _dcgrsCarrierGateway :: !(Maybe CarrierGateway)
...
deleteCarrierGatewayResponse pResponseStatus_ =
  DeleteCarrierGatewayResponse'
    {_dcgrsCarrierGateway = Nothing, _dcgrsResponseStatus = pResponseStatus_}
...
instance NFData DeleteCarrierGatewayResponse where
