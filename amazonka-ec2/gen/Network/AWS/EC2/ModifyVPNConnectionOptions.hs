...
data ModifyVPNConnectionOptions = ModifyVPNConnectionOptions'
  { _mvcoRemoteIPv4NetworkCidr :: !(Maybe Text)
  , _mvcoLocalIPv4NetworkCidr  :: !(Maybe Text)
  , _mvcoRemoteIPv6NetworkCidr :: !(Maybe Text)
  , _mvcoLocalIPv6NetworkCidr  :: !(Maybe Text)
...
instance Hashable ModifyVPNConnectionOptions where

instance NFData ModifyVPNConnectionOptions where
...
data ModifyVPNConnectionOptionsResponse = ModifyVPNConnectionOptionsResponse'
  { _mvcorsVPNConnection  :: !(Maybe VPNConnection)
  , _mvcorsResponseStatus :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
modifyVPNConnectionOptionsResponse
    :: Int -- ^ 'mvcorsResponseStatus'
    -> ModifyVPNConnectionOptionsResponse
modifyVPNConnectionOptionsResponse pResponseStatus_ =
  ModifyVPNConnectionOptionsResponse'
    {_mvcorsVPNConnection = Nothing, _mvcorsResponseStatus = pResponseStatus_}
