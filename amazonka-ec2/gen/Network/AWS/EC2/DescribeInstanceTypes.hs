...
instance AWSPager DescribeInstanceTypes where
        page rq rs
          ...
          | otherwise =
            Just $ rq & ditNextToken .~ rs ^. ditrsNextToken

instance AWSRequest DescribeInstanceTypes where
        type Rs DescribeInstanceTypes =
             DescribeInstanceTypesResponse
...
instance Hashable DescribeInstanceTypes where

instance NFData DescribeInstanceTypes where
        ...
        toQuery DescribeInstanceTypes'{..}
          = mconcat
              ["Action" =: ("DescribeInstanceTypes" :: ByteString),
               ...
               "NextToken" =: _ditNextToken, "DryRun" =: _ditDryRun,
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'ditrsInstanceTypes' - The instance type. For more information, see <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-types.html Instance types> in the /Amazon EC2 User Guide/ .
--
...
instance NFData DescribeInstanceTypesResponse where
