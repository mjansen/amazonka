...
data ModifyManagedPrefixList = ModifyManagedPrefixList'
  { _mmplCurrentVersion :: !(Maybe Integer)
  , _mmplRemoveEntries  :: !(Maybe [RemovePrefixListEntry])
  , _mmplPrefixListName :: !(Maybe Text)
  , _mmplAddEntries     :: !(Maybe [AddPrefixListEntry])
...
instance AWSRequest ModifyManagedPrefixList where
        type Rs ModifyManagedPrefixList =
             ModifyManagedPrefixListResponse
...
instance Hashable ModifyManagedPrefixList where

instance NFData ModifyManagedPrefixList where
...
data ModifyManagedPrefixListResponse = ModifyManagedPrefixListResponse'
  { _mmplrsPrefixList     :: !(Maybe ManagedPrefixList)
  , _mmplrsResponseStatus :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
modifyManagedPrefixListResponse
    :: Int -- ^ 'mmplrsResponseStatus'
    -> ModifyManagedPrefixListResponse
modifyManagedPrefixListResponse pResponseStatus_ =
  ModifyManagedPrefixListResponse'
    {_mmplrsPrefixList = Nothing, _mmplrsResponseStatus = pResponseStatus_}
...
instance NFData ModifyManagedPrefixListResponse where
