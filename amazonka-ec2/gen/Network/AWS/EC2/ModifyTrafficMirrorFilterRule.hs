...
instance AWSRequest ModifyTrafficMirrorFilterRule
         where
...
instance Hashable ModifyTrafficMirrorFilterRule where

instance NFData ModifyTrafficMirrorFilterRule where

instance ToHeaders ModifyTrafficMirrorFilterRule
         where
