...
deleteManagedPrefixList
    :: Text -- ^ 'dmplPrefixListId'
    -> DeleteManagedPrefixList
deleteManagedPrefixList pPrefixListId_ =
  DeleteManagedPrefixList'
    {_dmplDryRun = Nothing, _dmplPrefixListId = pPrefixListId_}
...
instance AWSRequest DeleteManagedPrefixList where
        type Rs DeleteManagedPrefixList =
             DeleteManagedPrefixListResponse
...
instance Hashable DeleteManagedPrefixList where

instance NFData DeleteManagedPrefixList where
...
data DeleteManagedPrefixListResponse = DeleteManagedPrefixListResponse'
  { _dmplrsPrefixList     :: !(Maybe ManagedPrefixList)
  , _dmplrsResponseStatus :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
deleteManagedPrefixListResponse
    :: Int -- ^ 'dmplrsResponseStatus'
    -> DeleteManagedPrefixListResponse
deleteManagedPrefixListResponse pResponseStatus_ =
  DeleteManagedPrefixListResponse'
    {_dmplrsPrefixList = Nothing, _dmplrsResponseStatus = pResponseStatus_}
...
instance NFData DeleteManagedPrefixListResponse where
