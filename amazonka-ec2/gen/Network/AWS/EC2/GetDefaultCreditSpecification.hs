...
instance AWSRequest GetDefaultCreditSpecification
         where
...
instance Hashable GetDefaultCreditSpecification where

instance NFData GetDefaultCreditSpecification where

instance ToHeaders GetDefaultCreditSpecification
         where
