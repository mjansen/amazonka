...
data DescribeManagedPrefixLists = DescribeManagedPrefixLists'
  { _dmplsFilters       :: !(Maybe [Filter])
  , _dmplsPrefixListIds :: !(Maybe [Text])
...
instance AWSPager DescribeManagedPrefixLists where
        page rq rs
          ...
          | otherwise =
            Just $ rq & dmplsNextToken .~ rs ^. dmplsrsNextToken
...
instance Hashable DescribeManagedPrefixLists where

instance NFData DescribeManagedPrefixLists where
        ...
        toQuery DescribeManagedPrefixLists'{..}
          = mconcat
              ["Action" =:
               ...
               toQuery
                 (toQueryList "PrefixListId" <$> _dmplsPrefixListIds),
...
data DescribeManagedPrefixListsResponse = DescribeManagedPrefixListsResponse'
  { _dmplsrsNextToken      :: !(Maybe Text)
  , _dmplsrsPrefixLists    :: !(Maybe [ManagedPrefixList])
  , _dmplsrsResponseStatus :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
