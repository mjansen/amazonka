...
instance AWSRequest ModifyVPNTunnelOptions where
        type Rs ModifyVPNTunnelOptions =
             ModifyVPNTunnelOptionsResponse
...
instance Hashable ModifyVPNTunnelOptions where

instance NFData ModifyVPNTunnelOptions where
...
instance NFData ModifyVPNTunnelOptionsResponse where
