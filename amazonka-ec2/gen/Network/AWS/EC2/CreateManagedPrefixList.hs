...
data CreateManagedPrefixList = CreateManagedPrefixList'
  { _cmplClientToken       :: !(Maybe Text)
  , _cmplEntries           :: !(Maybe [AddPrefixListEntry])
  , _cmplTagSpecifications :: !(Maybe [TagSpecification])
...
createManagedPrefixList
    :: Text -- ^ 'cmplPrefixListName'
    -> Int -- ^ 'cmplMaxEntries'
    -> Text -- ^ 'cmplAddressFamily'
    -> CreateManagedPrefixList
createManagedPrefixList pPrefixListName_ pMaxEntries_ pAddressFamily_ =
  CreateManagedPrefixList'
...
instance AWSRequest CreateManagedPrefixList where
        type Rs CreateManagedPrefixList =
             CreateManagedPrefixListResponse
...
instance Hashable CreateManagedPrefixList where

instance NFData CreateManagedPrefixList where
...
data CreateManagedPrefixListResponse = CreateManagedPrefixListResponse'
  { _cmplrsPrefixList     :: !(Maybe ManagedPrefixList)
  , _cmplrsResponseStatus :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
createManagedPrefixListResponse
    :: Int -- ^ 'cmplrsResponseStatus'
    -> CreateManagedPrefixListResponse
createManagedPrefixListResponse pResponseStatus_ =
  CreateManagedPrefixListResponse'
    {_cmplrsPrefixList = Nothing, _cmplrsResponseStatus = pResponseStatus_}
...
instance NFData CreateManagedPrefixListResponse where
