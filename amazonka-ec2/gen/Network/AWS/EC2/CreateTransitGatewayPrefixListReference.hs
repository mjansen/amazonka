...
data CreateTransitGatewayPrefixListReference = CreateTransitGatewayPrefixListReference'
  { _ctgplrBlackhole                  :: !(Maybe Bool)
  , _ctgplrTransitGatewayAttachmentId :: !(Maybe Text)
  , _ctgplrDryRun                     :: !(Maybe Bool)
  , _ctgplrTransitGatewayRouteTableId :: !Text
  , _ctgplrPrefixListId               :: !Text
...
createTransitGatewayPrefixListReference
    :: Text -- ^ 'ctgplrTransitGatewayRouteTableId'
    -> Text -- ^ 'ctgplrPrefixListId'
    -> CreateTransitGatewayPrefixListReference
createTransitGatewayPrefixListReference pTransitGatewayRouteTableId_ pPrefixListId_ =
  CreateTransitGatewayPrefixListReference'
    { _ctgplrBlackhole = Nothing
    , _ctgplrTransitGatewayAttachmentId = Nothing
    , _ctgplrDryRun = Nothing
    , _ctgplrTransitGatewayRouteTableId = pTransitGatewayRouteTableId_
...
data CreateTransitGatewayPrefixListReferenceResponse = CreateTransitGatewayPrefixListReferenceResponse'
  { _ctgplrrsTransitGatewayPrefixListReference :: !(Maybe TransitGatewayPrefixListReference)
  , _ctgplrrsResponseStatus :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
createTransitGatewayPrefixListReferenceResponse
    :: Int -- ^ 'ctgplrrsResponseStatus'
    -> CreateTransitGatewayPrefixListReferenceResponse
createTransitGatewayPrefixListReferenceResponse pResponseStatus_ =
  CreateTransitGatewayPrefixListReferenceResponse'
    { _ctgplrrsTransitGatewayPrefixListReference = Nothing
