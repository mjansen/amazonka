...
data GetManagedPrefixListEntries = GetManagedPrefixListEntries'
  { _gmpleNextToken     :: !(Maybe Text)
  , _gmpleTargetVersion :: !(Maybe Integer)
...
instance AWSPager GetManagedPrefixListEntries where
        page rq rs
          ...
          | otherwise =
            Just $ rq & gmpleNextToken .~ rs ^. gmplersNextToken
...
instance Hashable GetManagedPrefixListEntries where

instance NFData GetManagedPrefixListEntries where
...
data GetManagedPrefixListEntriesResponse = GetManagedPrefixListEntriesResponse'
  { _gmplersEntries        :: !(Maybe [PrefixListEntry])
  , _gmplersNextToken      :: !(Maybe Text)
  , _gmplersResponseStatus :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
