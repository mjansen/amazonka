...
data AssociateEnclaveCertificateIAMRole = AssociateEnclaveCertificateIAMRole'
  { _aecirCertificateARN :: !(Maybe Text)
  , _aecirDryRun         :: !(Maybe Bool)
  , _aecirRoleARN        :: !(Maybe Text)
...
instance ToHeaders AssociateEnclaveCertificateIAMRole
         where
        toHeaders = const mempty

instance ToPath AssociateEnclaveCertificateIAMRole
         where
        toPath = const "/"

instance ToQuery AssociateEnclaveCertificateIAMRole
         where
        toQuery AssociateEnclaveCertificateIAMRole'{..}
          = mconcat
              ["Action" =:
               ...
               "DryRun" =: _aecirDryRun, "RoleArn" =: _aecirRoleARN]
...
data AssociateEnclaveCertificateIAMRoleResponse = AssociateEnclaveCertificateIAMRoleResponse'
  { _aecirrsCertificateS3BucketName :: !(Maybe Text)
  , _aecirrsCertificateS3ObjectKey  :: !(Maybe Text)
  , _aecirrsEncryptionKMSKeyId      :: !(Maybe Text)
  , _aecirrsResponseStatus          :: !Int
  } deriving (Eq, Read, Show, Data, Typeable, Generic)
...
associateEnclaveCertificateIAMRoleResponse
    :: Int -- ^ 'aecirrsResponseStatus'
    -> AssociateEnclaveCertificateIAMRoleResponse
associateEnclaveCertificateIAMRoleResponse pResponseStatus_ =
  AssociateEnclaveCertificateIAMRoleResponse'
    { _aecirrsCertificateS3BucketName = Nothing
