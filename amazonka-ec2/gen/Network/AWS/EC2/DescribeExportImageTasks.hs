...
instance AWSPager DescribeExportImageTasks where
        page rq rs
          ...
          | otherwise =
            Just $ rq & deitNextToken .~ rs ^. deitrsNextToken

instance AWSRequest DescribeExportImageTasks where
        type Rs DescribeExportImageTasks =
             DescribeExportImageTasksResponse
...
instance Hashable DescribeExportImageTasks where

instance NFData DescribeExportImageTasks where
