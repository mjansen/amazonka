...
instance Hashable DescribeIPv6Pools where

instance NFData DescribeIPv6Pools where
        ...
        toQuery DescribeIPv6Pools'{..}
          = mconcat
              ["Action" =: ("DescribeIpv6Pools" :: ByteString),
               ...
               "NextToken" =: _dipNextToken, "DryRun" =: _dipDryRun,
...
instance NFData DescribeIPv6PoolsResponse where
